...
export class DataService {
  ...
  serviceStaff: Staff[] = [
    { name: 'Alice Johnson', role: 'Manager', id: 'R1' ,checked:true,details:{image:'https://t3.ftcdn.net/jpg/02/99/04/20/360_F_299042079_vGBD7wIlSeNl7vOevWHiL93G4koMM967.jpg'}},
    { name: 'Bob Smith', role: 'Assistant Manager', id: 'R2' ,checked:false,details:{image:'https://img.freepik.com/free-photo/young-bearded-man-with-striped-shirt_273609-5677.jpg'}},
    { name: 'Charlie Brown', role: 'Supervisor', id: 'R3',checked:false,details:{image:'https://img.freepik.com/premium-photo/portrait-smiling-young-man-looking-camera_33839-1731.jpg'} },
    { name: 'Diana Prince', role: 'Coordinator', id: 'R4',checked:false ,details:{image:'https://cdn.create.vista.com/api/media/small/308705620/stock-photo-smiling-brunette-woman-in-an-orange-t-shirt-and-beautiful-headband-holding-handsin-a-gesture'}},
    { name: 'Edward Stark', role: 'Team Lead', id: 'R5' ,checked:false,details:{image:'https://images.inc.com/uploaded_files/image/1920x1080/getty_481292845_77896.jpg'}},
    { name: 'Fiona Green', role: 'Executive', id: 'R6',checked:false ,details:{image:'https://t3.ftcdn.net/jpg/03/02/88/46/360_F_302884605_actpipOdPOQHDTnFtp4zg4RtlWzhOASp.jpg'}},
    { name: 'George Miller', role: 'Senior Manager', id: 'R7' ,checked:false,details:{image:'https://st4.depositphotos.com/1591576/20942/i/450/depositphotos_209420114-stock-photo-close-horizontal-portrait-stubble-bearded.jpg'}},
